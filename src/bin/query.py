...
class Search:
    ...
    def add_view(self, id):
        ...
        self.mycursor.execute(
            "SELECT times_accessed FROM recipes WHERE id=" + id
        )
        temp_list = []
